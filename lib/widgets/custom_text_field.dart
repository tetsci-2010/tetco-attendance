  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: controller?.text.isEmpty == true || controller == null ? null : ClearButton(onClearTap: onClearTap),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(Icons.clear, color: kRedColor, size: sizeConstants.iconSmall),
      ),
    );
  }
}
